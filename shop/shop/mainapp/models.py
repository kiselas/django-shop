...
class Product(models.Model):
    ...
    #         resized_new_image = new_img.resize(self.MAX_RESOLUTION, Image.ANTIALIAS)
    #         filestream = BytesIO()
    ...
    #                 filestream, 'ImageField', name, 'jpeg/image', None, sys.getsizeof(filestream)
    #         )
...
class Customer(models.Model):
    ...
    orders = models.ManyToManyField('Order', verbose_name='Заказы покупателяя',
...
class Order(models.Model):
    ...
    order_date = models.DateField(verbose_name='Дата получения', default=timezone.now)
