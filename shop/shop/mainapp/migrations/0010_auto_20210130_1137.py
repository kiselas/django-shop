...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0009_auto_20210128_2338'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата получения')),
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='mainapp.Order', verbose_name='Заказы покупателяя'),
        ),
    ]
